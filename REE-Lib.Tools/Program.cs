...
internal sealed class Program
{
    ...
    private static void GenerateEFXTemplates(string outputFolder)
    {
        ...
        var files = new SyntaxTree [] {
            CSharpSyntaxTree.ParseText(File.ReadAllText(Path.Combine(basedir, "ReeLib/OtherFiles/EfxFile.cs")))
        }.Concat(Directory.GetFiles(Path.Combine(basedir, "ReeLib/OtherFiles/EFX")).Select(fn => CSharpSyntaxTree.ParseText(File.ReadAllText(fn))));
        ...
        var autogeneratedNotice = "// autogenerated using shadowcookie's ReeLib: https://github.com/kagenocookie/ReeLib";
