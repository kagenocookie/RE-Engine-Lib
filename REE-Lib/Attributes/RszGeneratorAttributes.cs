...
namespace ReeLib.InternalAttributes
{
    /// <summary>
    ...
    /// <summary>
    /// Statement to be used to determine the file version, placed at the beginning of the autogenerated default read/write methods.
    /// </summary>
    [System.AttributeUsage(System.AttributeTargets.Class, Inherited = false, AllowMultiple = false)]
    public sealed class RszAssignVersionAttribute : System.Attribute
    {
        public string AssignStatement { get; }

        public RszAssignVersionAttribute(string assignStatement = "var Version = handler.FileVersion;")
        {
