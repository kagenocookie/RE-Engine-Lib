...
public enum EfxAttributeType
{
    ...
    FixRandomGeneratorExpression,
    EffectShader,
    VortexelHeatReceiver,
    IndependentVolume,
    Transform2D,
    ...
    TypeRibbonParticleMaterial,
    TypeRibbonParticleMaterialClip,
    ...
    PtVortexelWind,
    PtVortexelWindExpression,
    VortexelWindEmitter,
    VortexelWindEmitterExpression,
    PtVortexelHeatSource,
    VortexelCollider,
    VortexelColliderExpression,
    VortexelIndoorMask,
    VortexelIndoorMaskExpression,
    PtVortexelPhysics,
    PtVortexelPhysicsSimple,
    PtVortexelSnap,
    ...
    AttractorExpression,
    ColorGrading,
    ColorGradingExpression,
    ContrastHighlighter,
    ParticleTimer,
    Trigger,
    CustomComputeShader,
    VolumeBufferInfluence,
    VolumeBufferOperator,
    DepthOcclusion,
    DepthOperator,
    DirectionalField,
    ...
    TypeLightningExpensive,
    PtLightningColliderAction,
    PtLightningBranchAction,
	...
	PointCloudEmitter,
	DumpGpuParticle,
	RibbonJointOffsetVelocity,
	RibbonJointScale,
	FluidParticleEmitter,
	FluidParticleEmitterTarget,
	FluidParticle2DSimulatorExpression,
	FluidParticleEmitter3D,
	PtMeshPartsAnim,
	PtMeshPartsAnimClip,
    FluidSimulator3D,
    FluidEmitter3D,
