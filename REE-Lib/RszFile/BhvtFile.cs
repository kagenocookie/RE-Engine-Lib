...
namespace ReeLib
{
    public class BhvtFile(RszFileOption option, FileHandler fileHandler) : BaseRszFile(option, fileHandler)
    {
            ...
            else
            {
                ...
                foreach (var node in Nodes)
                {
                    foreach (var act in node.Actions.Actions)
                    {
                        ...
                        RszInstance matched;
                        if (!actions.Remove(act.Action, out matched!)) {
                            var ex = 1;
        ...
        private static readonly HashSet<string> StaticClasses = [
            ...
            "snow.enemy.aifsm.Ems092_CheckUnregisterOrderList",
            "snow.enemy.aifsm.EnemySetTargetDir",
            "snow.enemy.aifsm.EnemySetTargetDirOffsetLR",
            "snow.enemy.em002.fsm.action.Em002HyakuryuAdjustHeightCountAction",
            "snow.enemy.em002.fsm.condition.Em002CheckHyakuryuAdjustHeightCount",
            "snow.enemy.em003.fsm.action.Em003CatchAttackCalcBlendRatioFromDistance",
            "snow.enemy.em004.fsm.action.Em004MultiPartsDamageSet",
            "snow.enemy.em007.fsm.action.Em007MoguriWaitTimer",
            "snow.enemy.em007.fsm.condition.Em007CheckBreakContactPropGimmick",
            "snow.enemy.em007.fsm.condition.Em007CheckMoguriWaitTimer",
            "snow.enemy.em019.fsm.condition.Em019_CheckGuardDamage",
            "snow.enemy.em025.fsm.condition.Em025CheckWallContactMoveDistance",
            "snow.enemy.em027.fsm.condition.Em027TargetAngleCheck",
            "snow.enemy.em032.fsm.condition.Em032CheckBreakContactPropGimmick",
            "snow.enemy.em032.fsm.condition.Em032CheckPrevAction",
            "snow.enemy.em032.fsm.condition.Em032CheckTiredRushClimbWallDownTimer",
            "snow.enemy.em062.fsm.action.Em062MultiPartsDamageSet",
            "snow.enemy.em077.fsm.action.Em077_00SetGiveUpToFlyStopActionFlag",
            "snow.enemy.em086.fsm.action.Em086_08StartCometShell",
            "snow.enemy.em086.fsm.action.Em086_08WarpToCometShellLaunchPos",
            "snow.enemy.em086.fsm.condition.Em086_08CheckPrevMotionDir",
            "snow.enemy.em086.fsm.condition.Em086ActionTimerCheck",
            "snow.enemy.em086.fsm.condition.Em086CheckCometAttackTakeOffEnd",
            "snow.enemy.em086.fsm.condition.Em086CheckCometAttackTurningEnd",
            "snow.enemy.em086.fsm.condition.Em086IntakeLoopMotionFsmTimerCheck",
            "snow.enemy.em089.fsm.condition.Em089CheckMotionDirection",
            "snow.enemy.em091.fsm.action.Em091MultiPartsDamageSet",
            "snow.enemy.em093.Em093_01_CalcBlendRatioFromAngleX",
            "snow.enemy.em093.fsm.condition.Em093_CircleSwimEndCheck",
            "snow.enemy.em093.fsm.condition.Em093_CircleSwimTurnDirCheck",
            "snow.enemy.em094.fsm.action.Em094_00InitChildShoot",
            "snow.enemy.em094.fsm.action.Em094_GatherWaitUpdate",
            "snow.enemy.em094.fsm.action.Em094_YarnCompleteWaitUpdate",
            "snow.enemy.em094.fsm.condition.Em094_00CheckChildShootEnd",
            "snow.enemy.em094.fsm.condition.Em094_00CheckCombinationJerkDir",
            "snow.enemy.em094.fsm.condition.Em094CheckChildGatherComplete",
            "snow.enemy.em094.fsm.condition.Em094CheckOrderYarnComplete",
            "snow.enemy.em095.fsm.action.Em095AdjustMudLabyrinthStartPosition",
            "snow.enemy.em095.fsm.action.Em095MudLabirynthSetup",
            "snow.enemy.em095.fsm.condition.Em095_CheckMudDunkPosture",
            "snow.enemy.em096.fsm.action.Em096_MotFsmStateSpecialAttackRollingTimeStart",
            "snow.enemy.em099.fsm.action.Em099_MotFsmStateSpecialAttackRollingTimeStart",
            "snow.enemy.em100.fsm.condition.Em100CheckEatMeatAnimationStatus",
            "snow.enemy.em107.fsm.condition.Em107_MotFSMCarryCheck",
            "snow.enemy.em108.fsm.condition.Em108_IsOnWater",
            "snow.enemy.em108.fsm.condition.Em108_TargetSearch",
            "snow.enemy.em109.fsm.action.Em109SetThornState",
            "snow.enemy.em109.fsm.condition.Em109CheckThornState",
            "snow.enemy.em131.fsm.condition.Em131_CheckMotFsmHeadPosStatus",
            "snow.enemy.em132.fsm.action.Em132_05EmergencyRequestDissolve",
            "snow.enemy.em132.fsm.action.Em132_05SetLeechAction",
            "snow.enemy.em132.fsm.action.Em132GrappleSetTargetPlayerPos",
            "snow.enemy.em132.fsm.action.Em132InitAdjustMoveToTargetPos",
            "snow.enemy.em132.fsm.action.Em132SetLeechAction",
            "snow.enemy.em132.fsm.action.Em132ShadoMoveLeechFollowEffect",
            "snow.enemy.em132.fsm.condition.Em132_05SecessionTakeOffCheck",
            "snow.enemy.em132.fsm.condition.Em132_05TargetAngleCheck",
            "snow.enemy.em132.fsm.condition.Em132_05TargetDistanceCheckFromOffset",
            "snow.enemy.em132.fsm.condition.Em132CheckAdjustMoveToTargetPos",
            "snow.enemy.em132.fsm.condition.Em132CheckLeechAction",
            "snow.enemy.em133.fsm.condition.Em133TargetPositionCheck",
            "snow.enemy.em135.fsm.action.Em135_00VacuumEffectActive",
            "snow.enemy.em135.fsm.action.Em135DirectHPDamageByDropping",
            "snow.enemy.em135.fsm.condition.Em135CheckFootLR",
            "snow.enemy.em135.fsm.condition.Em135CheckLowPosOnWall",
            "snow.enemy.em135.fsm.condition.Em135CheckPrevMotionDir",
            "snow.enemy.em135.fsm.condition.Em135CheckRotAnglePrevVacuum",
            "snow.enemy.ems003.fsm.action.Ems003DisableHagiPop",
            "snow.enemy.ems008.fsm.action.Ems008_InitStealParam",
            "snow.enemy.ems008.fsm.action.Ems008_PushItemAndDie",
            "snow.enemy.ems008.fsm.condition.Ems008_CheckStealWaitEnd",
            "snow.enemy.ems019.fsm.condition.Ems019IceDieTypeCheck",
            "snow.enemy.ems027.fsm.action.Ems027_EatStuffed",
            "snow.enemy.ems029.fsm.condition.Ems029_NaviMoveCancel",
            "snow.enemy.ems038.fsm.action.Ems038_IncrementKyoroCount",
            "snow.enemy.ems038.fsm.condition.Ems038CheckKyoroCount",
            "snow.enemy.ems090.fsm.action.Ems090_SetVitalEndureFlag",
            "snow.enemy.ems091.fsm.action.Ems091_05_ClearMureOrder",
            "snow.enemy.ems091.fsm.condition.Ems091_05_CheckUniqueNaviEnd",
            "snow.enemy.ems091.fsm.condition.Ems091_05_CheckUniqueNaviMoveEnd",
            "snow.enemy.ems092.fsm.condition.Ems092CheckEnableOrderYarn",
            "snow.enemy.ems092.fsm.condition.Ems092_CheckGatherComplete",
            "snow.enemy.ems092.fsm.condition.Ems092_CheckParentPullJumpStart",
            "snow.enemy.ems093.fsm.action.Ems093_MimicEndAction",
            "snow.enemy.ems093.fsm.action.Ems093_MimicStartAction",
            "snow.enemy.ems093.fsm.action.Ems093_SetTargetMimicLookPos",
            "snow.enemy.ems093.fsm.condition.Ems093_MotFsmCheckMimicState",
            "snow.enemy.ems094.fsm.action.Ems094_00EndUniqueStepUpAction",
            "snow.enemy.ems094.fsm.action.Ems094_00SetStepUpDownPos",
            "snow.enemy.ems094.fsm.action.Ems094_00StartUniqueStepDownAction",
            "snow.enemy.ems094.fsm.action.Ems094_00UniqueStepAction",
            "snow.enemy.fsm.action.EmBossTargetPosLerpMove",
            "snow.enemy.fsm.action.Ems019IceModelEnablePushCollision",
            "snow.enemy.fsm.action.EnemyAngleSetOffset",
            "snow.enemy.fsm.action.EnemyAngleSetTarget",
            "snow.enemy.fsm.action.EnemyCatchCheck",
            "snow.enemy.fsm.action.EnemyDieDamageStanceSet",
            "snow.enemy.fsm.action.EnemyFakeDieActionEndNotify",
            "snow.enemy.fsm.action.EnemyIgnoreMotSpeed",
            "snow.enemy.fsm.action.EnemyImmediateNaviNodeTurn",
            "snow.enemy.fsm.action.EnemyInitPosAccelSet",
            "snow.enemy.fsm.action.EnemyInitPosAdd",
            "snow.enemy.fsm.action.EnemyIntervalSetEnemysPush",
            "snow.enemy.fsm.action.EnemyMotClockwiseSet",
            "snow.enemy.fsm.action.EnemyMotLoopCounter",
            "snow.enemy.fsm.action.EnemyMotSpeedChg",
            "snow.enemy.fsm.action.EnemyMotTransScale",
            "snow.enemy.fsm.action.EnemyNaviOnWaterAction",
            "snow.enemy.fsm.action.EnemyNoCancelSet",
            "snow.enemy.fsm.action.EnemyNoDamageReactionSet",
            "snow.enemy.fsm.action.EnemyOffAllPushCollision",
            "snow.enemy.fsm.action.EnemyOffConditionActiveTimer",
            "snow.enemy.fsm.action.EnemyOffEmBorder",
            "snow.enemy.fsm.action.EnemyOffEnemyPushCollision",
            "snow.enemy.fsm.action.EnemyOffStanceDivingSetting",
            "snow.enemy.fsm.action.EnemySetNaviPassThroughDistance",
            "snow.enemy.fsm.action.EnemySetUniqueStanceNaviAction",
            "snow.enemy.fsm.action.PartsLossStartMotion",
            "snow.enemy.fsm.condition.Em060_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em061_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em062_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em071_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em086_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em089_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em090_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em092_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em093_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em095_MotFsmCheckCarryObject",
            "snow.enemy.fsm.condition.Em095_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em096_MotFsmCheckSpecialAttackRollingTimeCheck",
            "snow.enemy.fsm.condition.Em096_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em097_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em099_MotFsmCheckSpecialAttackRollingTimeCheck",
            "snow.enemy.fsm.condition.Em099_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em108_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Em133_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Ems029_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Ems040_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.Ems044_MotFsmCheckUniqueStance",
            "snow.enemy.fsm.condition.EnemyCatchMediateWait",
            "snow.enemy.fsm.condition.EnemyCatchWaitTimerCheck",
            "snow.enemy.fsm.condition.EnemyCheckCatchTransition",
            "snow.enemy.fsm.condition.EnemyCheckCharacterControllerWall",
            "snow.enemy.fsm.condition.EnemyCheckEm099ExIntrusionThreatWait",
            "snow.enemy.fsm.condition.EnemyCheckFlyBlockMoveDistanceRad",
            "snow.enemy.fsm.condition.EnemyCheckMotLoopCnt",
            "snow.enemy.fsm.condition.EnemyCheckResearchNaviMove",
            "snow.enemy.fsm.condition.EnemyCheckV15IntrusionThreatWait",
            "snow.enemy.fsm.condition.EnemyClimbWallTopCheck",
            "snow.enemy.fsm.condition.EnemyClimbWallTopCheckOnStartMotion",
            "snow.enemy.fsm.condition.EnemyDamageMotionFsmTimerCheck",
            "snow.enemy.fsm.condition.EnemyDirectMotionFsmTimerCheck",
            "snow.enemy.fsm.condition.EnemyDownWallBottomCheck",
            "snow.enemy.fsm.condition.EnemyGroundNothingCheck",
            "snow.enemy.fsm.condition.EnemyHeightCheck",
            "snow.enemy.fsm.condition.EnemyJumpEnd",
            "snow.enemy.fsm.condition.EnemyMotClockwiseCheck",
            "snow.enemy.fsm.condition.EnemyMotOldUseCheck",
            "snow.enemy.fsm.condition.EnemyMoveSpeedCheck",
            "snow.enemy.fsm.condition.EnemyNaviOnWaterCheck",
            "snow.enemy.fsm.condition.EnemySequenceMotionEnd",
            "snow.enemy.fsm.condition.EnemySuperJumpEnd",
            "snow.enemy.fsm.condition.EnemyTargetLRAngleCheck",
            "snow.enemy.fsm.condition.EnemyTargetLRCheck",
            "snow.enemy.fsm.condition.EnemyTotalMoveDistanceCheck",
            "snow.enemy.fsm.condition.PartsLossGroundCheck",
            "snow.enemy.fsm.condition.PartsLossMotionTypeCheck",
            "snow.enemy.fsm.condition.PartsLossStartMotionCheck",
            "snow.player.fsm.PlayerFsm2ConditionBaseIsDog",
            "snow.player.fsm.PlayerFsm2ConditionBaseIsEquipHelmNo",
            "snow.player.fsm.PlayerFsm2ConditionBaseSex",
            "snow.player.fsm.PlayerFsm2ConditionCheckTargetAngleTurnDir",
            "snow.player.fsm.PlayerFsm2ConditionIsGround",
            "snow.player.fsm.PlayerFsm2ConditionStamina",
        ];
    }
}
