...
{
    public static readonly DiagnosticDescriptor UnhandledFailure = new DiagnosticDescriptor("RSZT001", "Failed to execute RszTool generator", "There was an unexpected error: {0}", "Design", DiagnosticSeverity.Error, true);
